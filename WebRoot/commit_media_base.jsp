...
<div>
	<form id="form_x"  method="post" 
		...
		<table border="1px">
		  ...
		  <tr>
		   <td>设置视频优先级<br>(只能输入数字，0表示最低):</td>
		   <td><input type="text" name="weight" value="0" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" /></td>
		  </tr>
		  
		  <tr>
		   <td> 关键字(关键字之间用"|"<br>分隔,比如：运动|时尚|搞笑):</td>
		   <td> <input type="text" name="keyword" /></td>
		  </tr>
		  
		  <tr>
		   <td> <input type="button" onclick="submitForms()" value="提交数据" /> </td>
		   <td><input type="reset" value="清空" /><br /></textarea></td>
		  </tr>
